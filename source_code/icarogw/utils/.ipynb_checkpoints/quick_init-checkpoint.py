...
agroup='ligo.dev.o3.cbc.hubble.gwcosmo'):
    """
...
def initialize_events_dict(runs,type=None,snr_cut=None,ifar_cut=None,to_include = None):
    ...
    # This table is built from https://arxiv.org/abs/2010.14527

    'GW190403_051519': {'SNR': 8.0, 'ifar': 1/7.7,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190403A'},
    'GW190408_181802': {'T_NAME':'S191103a','SNR': 14.7, 'ifar': 1/1.0e-5,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190408A'},
    'GW190412': {'T_NAME':'S190412m','SNR': 18.9, 'ifar': 1/1.0e-5,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190412A'},
    'GW190413_052954': {'T_NAME':'S190413ac','SNR': 8.6, 'ifar': 1/7.2e-2,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190413A'},
    'GW190413_134308': {'T_NAME':'S190413i','SNR': 10.0, 'ifar': 1/3.8e-1,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190413B'},
    'GW190421_213856': {'T_NAME':'S190421ar','SNR': 10.6, 'ifar': 1/7.7e-4,'RUN':'O3a','TYPE':'BBH','IFOS':'HL','PE_NAME':'GW190421A'},
    'GW190424_180648': {'T_NAME':'S190424ao','SNR': 10.0, 'ifar': 1/2,'RUN':'O3a','TYPE':'BBH','IFOS':'L','PE_NAME':'GW190424A'}, # Set threshold of 1/2yr according to GWTC2.1
    'GW190425': {'T_NAME':'S190425z','SNR': 13.0, 'ifar': 1/7.5e-4,'RUN':'O3a','TYPE':'BNS','IFOS':'LV','PE_NAME':'GW190425A'},
    'GW190426_152155': {'T_NAME':'-','SNR': 10.1, 'ifar': 1/1.4,'RUN':'O3a','TYPE':'SPECIAL','IFOS':'HLV','PE_NAME':'GW190426A'},
    'GW190426_190642': {'T_NAME':'S190426c','SNR': 9.6, 'ifar': 1/4.1,'RUN':'O3a','TYPE':'BBH','IFOS':'HL','PE_NAME':'GW190426B'}, # New massive event in GWTC2.1
    'GW190503_185404': {'T_NAME':'S190503bf','SNR': 12.2, 'ifar': 1/1.0e-5,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190503A'},
    'GW190512_180714': {'T_NAME':'S190512at','SNR':12.80,'ifar':1.000000e+05,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190512A'},
    ...
    'GW190521': {'T_NAME':'S190521g','SNR':14.38,'ifar':4.900104e+03,'RUN':'O3a','TYPE':'SPECIAL','IFOS':'HLV','PE_NAME':'GW190521A'},
    ...
    'GW190531_023648': {'T_NAME':'-','SNR':10.0,'ifar':1/0.41,'RUN':'O3a','TYPE':'NSBH','IFOS':'HLV','PE_NAME':'GW190531A'}, #New troublesome event, possibly NSBH from GWTC2.1
    ...
    'GW190909_114149': {'T_NAME':'S190909w','SNR': 8.5, 'ifar': 1/1.1,'RUN':'O3a','TYPE':'SPECIAL','IFOS':'HL','PE_NAME':'GW190909A'}, # Recovered even with smaller SNR in GWTC2.1, deranked
    ...
    'GW190929_012149': {'T_NAME':'S190929d','SNR': 9.9, 'ifar': 1/2.0e-2,'RUN':'O3a','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW190929A'},
    'GW190930_133541': {'T_NAME':'S190930s','SNR': 10.0, 'ifar': 1/5.8e-1,'RUN':'O3a','TYPE':'BBH','IFOS':'HL','PE_NAME':'GW190930A'},
    ...
    'GW200208_130117': {'T_NAME':'S200208am','SNR':10.82,'ifar':3.218858e+03,'RUN':'O3b','TYPE':'BBH','IFOS':'HLV','PE_NAME':'GW200208A'},
    'GW200208_222617': {'T_NAME':'S200208q','SNR':8.91,'ifar':2.070506e-01,'RUN':'O3b','TYPE':'BBH','IFOS':'HL','PE_NAME':'GW200208B'},
